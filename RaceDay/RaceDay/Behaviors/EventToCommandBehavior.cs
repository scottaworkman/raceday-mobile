...
{
    /// <summary>
    /// Used along with the Custom Validation to run field validation with data in the control is changed.  The behavior
    /// will invoke a command that includes the validation rules for the field when triggered (typically by data change)
    /// </summary>
    /// 
